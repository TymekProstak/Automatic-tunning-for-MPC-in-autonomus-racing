...
DEFAULT_CATKIN_WS = os.path.expanduser(
    "~/Desktop/fs_control_amz/TUNE_CMA_ES"
)
...
MANUAL_THETA: Dict[str, float] = {
    # ---------------- Planner / model ----------------
    "mpc.bounds.max_vx": 15.66,
    "mpc.model.mux": 1.22,
    "mpc.model.muy": 1.26,
    "mpc.cost.q_sdot": 0.77,

    # ---------------- Costs ----------------
    "mpc.cost.q_ey": 2.38,
    "mpc.cost.Q_epsi": 28.30,
    "mpc.cost.R_dT": 20.31,
    "mpc.cost.R_u_ddelta_cmd": 6.29,
    "mpc.cost.R_Mtv": 1.77e-7,
    "mpc.cost.Q_beta": 0.31,
}
...
ROS_MASTER_PORT = int(os.environ.get("EVAL_ROS_MASTER_PORT", "11321"))
