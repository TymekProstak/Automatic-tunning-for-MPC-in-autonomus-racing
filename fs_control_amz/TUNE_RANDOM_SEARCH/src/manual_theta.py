...
MANUAL_THETA: Dict[str, float] = {
    ...
    # ---------------- Costs ----------------
    "mpc.cost.q_ey": 2.97,
    "mpc.cost.Q_epsi": 35.7,
    "mpc.cost.R_dT": 30.10,
    "mpc.cost.R_u_ddelta_cmd": 21.21,
    "mpc.cost.R_Mtv": 2.58e-6,
    "mpc.cost.Q_beta": 0.66,
}
...
ROS_MASTER_PORT = int(os.environ.get("EVAL_ROS_MASTER_PORT", "11322"))
