...
# Config
# ============================================================
WS="${EVAL_WS:-$HOME/Desktop/fs_control_amz/TUNE_RANDOM_SEARCH}"
...
RUN_LOG_JSONL="${EVAL_RUN_LOG_PATH:-$WS/src/random_search/tuning_run_full_coupled_staged_random_search_night_4track.jsonl}"
