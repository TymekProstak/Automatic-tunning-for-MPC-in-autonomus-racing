...
DEFAULT_CATKIN_WS = os.path.expanduser(
    "~/Desktop/fs_control_amz/NO_STAGE/TUNE_BO_gp"
)
...
MANUAL_THETA: Dict[str, float] = {
    # ---------------- Planner / model ----------------
    "mpc.bounds.max_vx": 13.65,
    "mpc.model.mux": 0.71,
    "mpc.model.muy": 1.39,
    "mpc.cost.q_sdot": 0.15,

    # ---------------- Costs ----------------
    "mpc.cost.q_ey": 0.83,
    "mpc.cost.Q_epsi": 0.26,
    "mpc.cost.R_dT": 3.19,
    "mpc.cost.R_u_ddelta_cmd": 9.99,
    "mpc.cost.R_Mtv": 2.09e-7,
    "mpc.cost.Q_beta": 0.02,
}
...
# ============================================================
COST_BOUNDS = {
    "mpc.cost.q_ey": (0.1, 100.0),
    "mpc.cost.Q_epsi": (0.1, 100.0),
    "mpc.cost.R_dT": (0.1, 100.0),
    "mpc.cost.R_u_ddelta_cmd": (0.1, 100.0),
    "mpc.cost.R_Mtv": (1e-8, 1e-5),
    "mpc.cost.Q_beta": (0.01, 10.0),
}
...
ROS_MASTER_PORT = int(os.environ.get("EVAL_ROS_MASTER_PORT", "11420"))
