...
MANUAL_THETA: Dict[str, float] = {
    # ---------------- Planner / model ----------------
    "mpc.bounds.max_vx": 14.78,
    "mpc.model.mux": 1.34,
    "mpc.model.muy": 1.39,
    "mpc.cost.q_sdot": 0.32,

    # ---------------- Costs ----------------
    "mpc.cost.q_ey": 1.57,
    "mpc.cost.Q_epsi": 31.9,
    "mpc.cost.R_dT": 1.73,
    "mpc.cost.R_u_ddelta_cmd": 2.18,
    "mpc.cost.R_Mtv": 2.8e-7,
    "mpc.cost.Q_beta": 1.96,
}
...
ROS_MASTER_PORT = int(os.environ.get("EVAL_ROS_MASTER_PORT", "11419"))
