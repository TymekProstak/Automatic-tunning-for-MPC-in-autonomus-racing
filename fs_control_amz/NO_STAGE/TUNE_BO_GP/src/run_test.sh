...
# Config
# ============================================================
WS="${EVAL_WS:-$HOME/Desktop/fs_control_amz/NO_STAGE/TUNE_BO_GP}"
PY_SCRIPT_REL="${EVAL_PY_SCRIPT_REL:-src/BO_GP/eval.py}"
RUN_LOG_JSONL="${EVAL_RUN_LOG_PATH:-$WS/src/BO_GP/tuning_run_joint_gpbo_night_4track.jsonl}"
...
RUNNER_LOG="$RUN_LOG_DIR/eval_full_coupled_gp_bo_${STAMP}.log"
...
# export EVAL_OUTPUT_CSV="$WS/src/BO_GP/eval_full_coupled_gp_bo_test_tracks.csv"
# export EVAL_BEST_SO_FAR_EVERY=10
# export EVAL_SURROGATE_EVERY=12
# export EVAL_TOPK=3
# export EVAL_SURROGATE_KIND=pred_mean
# export EVAL_SIM_TIME_S=60
# export EVAL_ROS_MASTER_PORT=11335
