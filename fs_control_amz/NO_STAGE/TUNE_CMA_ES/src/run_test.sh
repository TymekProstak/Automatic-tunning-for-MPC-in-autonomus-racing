...
# Config
# ============================================================
WS="${EVAL_WS:-$HOME/Desktop/fs_control_amz/NO_STAGE/TUNE_CMA_ES}"
PY_SCRIPT_REL="${EVAL_PY_SCRIPT_REL:-src/CMA_ES/eval.py}"
RUN_LOG_JSONL="${EVAL_RUN_LOG_PATH:-$WS/src/CMA_ES/tuning_run_full_coupled_unstaged_cma_night_4track.jsonl}"
...
RUNNER_LOG="$RUN_LOG_DIR/eval_cma_full_coupled_${STAMP}.log"
...
# Możesz to nadpisać przed uruchomieniem w razie potrzeby:
# export EVAL_OUTPUT_CSV="$WS/src/CMA_ES/cma_test_results_full_coupled.csv"
