...
DEFAULT_CATKIN_WS = os.path.expanduser(
    "~/Desktop/fs_control_amz/NO_STAGE/TUNE_CMA_ES"
)
...
MANUAL_THETA: Dict[str, float] = {
    # ---------------- Planner / model ----------------
    "mpc.bounds.max_vx": 15.62,
    "mpc.model.mux": 1.40,
    "mpc.model.muy": 1.32,
    "mpc.cost.q_sdot": 0.72,

    # ---------------- Costs ----------------
    "mpc.cost.q_ey": 1.0,
    "mpc.cost.Q_epsi": 2.48,
    "mpc.cost.R_dT": 3.16,
    "mpc.cost.R_u_ddelta_cmd": 14.19,
    "mpc.cost.R_Mtv": 9.99e-6,
    "mpc.cost.Q_beta": 8.42,
}
...
ROS_MASTER_PORT = int(os.environ.get("EVAL_ROS_MASTER_PORT", "11421"))
