...
MANUAL_THETA: Dict[str, float] = {
    ...
    # ---------------- Costs ----------------
    "mpc.cost.q_ey": 0.21,
    "mpc.cost.Q_epsi": 18.36,
    "mpc.cost.R_dT": 0.41,
    "mpc.cost.R_u_ddelta_cmd": 12.47,
    "mpc.cost.R_Mtv": 9.62e-7,
    "mpc.cost.Q_beta": 0.33,
}
...
ROS_MASTER_PORT = int(os.environ.get("EVAL_ROS_MASTER_PORT", "11422"))
