...
DEFAULT_CATKIN_WS = os.path.expanduser(
    "~/Desktop/fs_control_amz/TUNE_BO_TPO"
)
...
MANUAL_THETA: Dict[str, float] = {
    # ---------------- Planner / model ----------------
    "mpc.bounds.max_vx": 15.68,
    "mpc.model.mux": 1.14,
    "mpc.model.muy": 1.24,
    "mpc.cost.q_sdot": 0.48,

    # ---------------- Costs ----------------
    "mpc.cost.q_ey": 2.13,
    "mpc.cost.Q_epsi": 8.37,
    "mpc.cost.R_dT": 2.28,
    "mpc.cost.R_u_ddelta_cmd": 8.98,
    "mpc.cost.R_Mtv": 5.3e-6,
    "mpc.cost.Q_beta": 1.28,
}
...
ROS_MASTER_PORT = int(os.environ.get("EVAL_ROS_MASTER_PORT", "11320"))
