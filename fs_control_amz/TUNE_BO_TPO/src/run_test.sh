...
# Wskazujemy na skrypt Pythona dla TPE w wersji Full Coupled
PY_SCRIPT_REL="${EVAL_PY_SCRIPT_REL:-src/BO_TPO/eval.py}"

# Ścieżka do logów z tuningu TPE Full Coupled (stąd bierzemy kandydatów)
RUN_LOG_JSONL="${EVAL_RUN_LOG_PATH:-$WS/src/BO_TPO/tuning_run_full_coupled_tpe_night_4track.jsonl}"
