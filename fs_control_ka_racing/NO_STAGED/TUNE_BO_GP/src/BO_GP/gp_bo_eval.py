...
if EVAL_PROFILE_NAME == "smoke_3track":
    ...
    # train source = unstaged smoke_1track
    DEFAULT_RUN_LOG_NAME = "tuning_run_unstaged_gpbo_smoke_1track.jsonl"
    DEFAULT_OUTPUT_CSV_NAME = "unstaged_gpbo_test_eval_smoke3tracks.csv"
    DEFAULT_OUTPUT_CANDIDATES_NAME = "unstaged_gpbo_test_candidates_smoke3tracks.json"
    DEFAULT_PLOTS_DIR_NAME = "unstaged_gpbo_eval_plots_smoke3tracks"
    ...
    # train source = unstaged night_4track
    DEFAULT_RUN_LOG_NAME = "tuning_run_unstaged_gpbo_night_4track.jsonl"
    DEFAULT_OUTPUT_CSV_NAME = "unstaged_gpbo_test_eval_night7tracks.csv"
    DEFAULT_OUTPUT_CANDIDATES_NAME = "unstaged_gpbo_test_candidates_night7tracks.json"
    DEFAULT_PLOTS_DIR_NAME = "unstaged_gpbo_eval_plots_night7tracks"
...
ROS_MASTER_PORT = int(os.environ.get("EVAL_ROS_MASTER_PORT", "11411"))
START_ROSCORE_IF_NEEDED = True

ROS_HOME = os.path.expanduser(f"~/.ros_eval_unstaged_gpbo_{EVAL_PROFILE_NAME}")
...
def main() -> None:
    ...
    print("[INFO] algorithm_thinks uses the latest available surrogate snapshot up to each checkpoint.")
