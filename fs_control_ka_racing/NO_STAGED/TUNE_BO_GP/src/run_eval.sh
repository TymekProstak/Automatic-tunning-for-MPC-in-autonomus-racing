...
# Config
# ============================================================
WS="${EVAL_WS:-$HOME/Desktop/fs_control_ka_racing//NO_STAGED/TUNE_BO_GP}"
PY_SCRIPT_REL="${EVAL_PY_SCRIPT_REL:-src/BO_GP/gp_bo_eval.py}"
RUN_LOG_JSONL="${EVAL_RUN_LOG_PATH:-$WS/src/BO_GP/tuning_run_unstaged_gpbo_night_4track.jsonl}"
...
RUNNER_LOG="$RUN_LOG_DIR/eval_gpbo_test_tracks_${STAMP}.log"
...
# export EVAL_OUTPUT_CSV="$WS/src/BO_GP/my_eval.csv"
