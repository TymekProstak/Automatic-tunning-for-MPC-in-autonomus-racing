...
# Config
# ============================================================
WS="${EVAL_WS:-$HOME/Desktop/fs_control_ka_racing/NO_STAGED/TUNE_RANDOM_SEARCH}"
...
RUN_LOG_JSONL="${EVAL_RUN_LOG_PATH:-$WS/src/random_search/tuning_run_unstaged_random_search_night_4track.jsonl}"
