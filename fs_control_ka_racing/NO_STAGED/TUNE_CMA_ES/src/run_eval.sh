...
# Config
# ============================================================
WS="${EVAL_WS:-$HOME/Desktop/fs_control_ka_racing/NO_STAGED/TUNE_CMA_ES}"
PY_SCRIPT_REL="${EVAL_PY_SCRIPT_REL:-src/evolution_optimization/eval.py}"
RUN_LOG_JSONL="${EVAL_RUN_LOG_PATH:-$WS/src/evolution_optimization/tuning_run_unstaged_cma_night_4track.jsonl}"
...
RUNNER_LOG="$RUN_LOG_DIR/eval_cma_test_tracks_${STAMP}.log"
...
# export EVAL_OUTPUT_CSV="$WS/src/CMA_ES/my_eval.csv"
