...
MANUAL_THETA: Dict[str, float] = {
    # ---------------- Planner ----------------
    "velocity_planner.v_max": 15.5,
    "velocity_planner.mux_acc": 0.45,
    "velocity_planner.mux_dec": 0.7,
    "velocity_planner.muy": 0.65,

    # ---------------- Costs ----------------
    "mpc.cost.Q_y": 30.0,
    "mpc.cost.Q_psi": 60.0,
    "mpc.cost.R_ddelta": 7.0,
}
...
ROS_MASTER_PORT = int(os.environ.get("EVAL_ROS_MASTER_PORT", "11341"))
