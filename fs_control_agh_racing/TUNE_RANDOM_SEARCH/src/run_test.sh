...
# Config
# ============================================================
WS="${EVAL_WS:-$HOME/Desktop/fs_control_agh_racing/TUNE_RANDOM_SEARCH}"

PY_SCRIPT_REL="${EVAL_PY_SCRIPT_REL:-src/random_search/eval.py}"
RUN_LOG_JSONL="${EVAL_RUN_LOG_PATH:-$WS/src/random_search/tuning_run_random_search_tv_night_4track.jsonl}"
...
export EVAL_ROS_MASTER_PORT="${EVAL_ROS_MASTER_PORT:-11318}"
