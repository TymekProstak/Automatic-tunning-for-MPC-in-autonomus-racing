...
# Config
# ============================================================
WS="${EVAL_WS:-$HOME/Desktop/fs_control_agh_racing/NO_STAGED/TUNE_BO_TPO}"
...
RUN_LOG_JSONL="${EVAL_RUN_LOG_PATH:-$WS/src/BO_TPO/tuning_run_tpe_tv_unstaged_night_4track.jsonl}"
