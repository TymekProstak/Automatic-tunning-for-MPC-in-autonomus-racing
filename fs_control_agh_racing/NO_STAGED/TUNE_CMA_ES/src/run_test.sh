...
# Config
# ============================================================
WS="${EVAL_WS:-$HOME/Desktop/fs_control_agh_racing/NO_STAGED/TUNE_CMA_ES}"
PY_SCRIPT_REL="${EVAL_PY_SCRIPT_REL:-src/evolution_optimization/eval.py}"
RUN_LOG_JSONL="${EVAL_RUN_LOG_PATH:-$WS/src/evolution_optimization/tuning_run_tv_unstaged_night_4track.jsonl}"
